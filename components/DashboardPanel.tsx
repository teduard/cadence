...
export function DashboardPanel({ day, score, days, scores }: Props) {
  ...
  console.log("xxxxx allItems:", allItems);

  const dayCount = days?.length ?? 0;

  let MAX_DAYS = Math.min(1000, dayCount-1);
  ...
  let categories = [
            ...
            "trecut cheltuielile in telefon",
            //"administrare chirie",
            "cumparaturi lidl"
          ];
